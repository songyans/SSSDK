...
@interface SS_SDKBasicInfo : NSObject
/* *urlScheme */
@property (nonatomic, copy) NSString *urlScheme;
/* *游戏appKey */
@property (nonatomic, copy) NSString *ss_AppId;                 
...
/* *手机系统版本 */
@property (strong) NSString *system_Version;      
/* *手机本地保存，app对应的唯一表示； */
...
/* *zhifu */
@property (nonatomic ,copy) NSString *syUrl; 
/* *token值 */
...
/* *强制绑定身份信息model */
@property (nonatomic ,strong) SS_BindIdentituInfoModel *bindModel;
/* *正则表达式model */
@property (nonatomic ,strong) SS_RegexModel *regexModel;
/* *是否是自己出包 */
...
@property (strong) NSString *ipAddress;     //ip地址

...
@interface SS_WebTipSController ()<WKNavigationDelegate,WKUIDelegate,WKScriptMessageHandler>
...
@implementation SS_WebTipSController
- (void)dealloc{
...
- (void)setUpWebView{
    ...
    self.requestUrl = [NSString stringWithFormat:@"%@?platform=ios&token=%@", SS_URL_GameTips, [SS_SDKBasicInfo sharedSS_SDKBasicInfo].sdkToken];
    [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:self.requestUrl]]];
...
- (void)showHUDForViewIsLoading{
    ...
    //    UIImageView *customImg = [[UIImageView alloc] initWithImage:[SS_PublicTool getImageFromBundle:[SS_PublicTool getResourceBundle] withName:@"key" withType:@"png"]];

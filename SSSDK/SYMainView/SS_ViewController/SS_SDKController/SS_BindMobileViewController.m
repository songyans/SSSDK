...
#import "SS_BindMobileViewController.h"
#import "SS_CustomerServiceViewController.h"


@interface SS_BindMobileViewController ()<UITextFieldDelegate>
...
@implementation SS_BindMobileViewController
...
- (void)sureClick:(id)sender{
    ...
    if (self.codeTextField.text.length < 1) {
      ...
      [[SS_SDKNetworkTool sharedSS_SDKNetworkTool] bindMobileWithToken:[SS_SDKBasicInfo sharedSS_SDKBasicInfo].sdkToken code:self.codeTextField.text phoneNumber:self.phoneNumTextField.text completion:^(BOOL isSuccess, id respones) {
          if (isSuccess) {
...
- (void)getClick:(id)sender{
    ...
    if (isTel) {
        ...
        [[SS_SDKNetworkTool sharedSS_SDKNetworkTool] bindPhoneSmsWithPhoneNumber:self.phoneNumTextField.text completion:^(BOOL isSuccess, id respones) {
            if (isSuccess) {
                SYLog(@"-------respones:%@", respones);
...
//        [_getCodeBtn setBackgroundImage:[SS_PublicTool getImageFromBundle:[SS_PublicTool getResourceBundle] withName:@"jhma" withType:@"png"] forState:UIControlStateNormal];
//        [_getCodeBtn setBackgroundImage:[SS_PublicTool getImageFromBundle:[SS_PublicTool getResourceBundle] withName:@"jhma_2" withType:@"png"] forState:UIControlStateHighlighted];

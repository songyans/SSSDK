...
#import "SS_ModifyController.h"

@interface SS_ModifyController ()<UITextFieldDelegate>
...
@implementation SS_ModifyController
...
- (void)sureClick:(id)sender{
    ...
    [[SS_SDKNetworkTool sharedSS_SDKNetworkTool] modifyPasswordWithToken:[SS_SDKBasicInfo sharedSS_SDKBasicInfo].sdkToken oldPassword:self.oldPassTextField.text password:self.passTextField.text repasswrod:self.rePassTextField.text completion:^(BOOL isSuccess, id respones) {
        if (isSuccess) {
...
- (void)showClick:(UIButton *)sender{
    ...
    if (sender.tag == 101) {
        ...
        if (self.isShowOldPassword) {
            [self.oldEyesBtn setImage:[SS_PublicTool getImageFromBundle:[SS_PublicTool getResourceBundle] withName:@"key_on" withType:@"png"] forState:UIControlStateNormal];
            self.oldPassTextField.secureTextEntry = NO;
            
            SYLog(@"----显示密码");
            
        }else{
            [self.oldEyesBtn setImage:[SS_PublicTool getImageFromBundle:[SS_PublicTool getResourceBundle] withName:@"key_off" withType:@"png"] forState:UIControlStateNormal];
        ...
        if (self.isShowRePassword) {
            [self.reEyesBtn setImage:[SS_PublicTool getImageFromBundle:[SS_PublicTool getResourceBundle] withName:@"key_on" withType:@"png"] forState:UIControlStateNormal];
            self.rePassTextField.secureTextEntry = NO;
            SYLog(@"----显示密码");
        }else{
            [self.reEyesBtn setImage:[SS_PublicTool getImageFromBundle:[SS_PublicTool getResourceBundle] withName:@"key_off" withType:@"png"] forState:UIControlStateNormal];
...
- (UIButton *)createButton:(UIButton *)button{
    ...
    [button setImage:[SS_PublicTool getImageFromBundle:[SS_PublicTool getResourceBundle] withName:@"key_off" withType:@"png"] forState:UIControlStateNormal];
...
//        [_sureBtn setBackgroundImage:[SS_PublicTool getImageFromBundle:[SS_PublicTool getResourceBundle] withName:@"an_z1" withType:@"png"] forState:UIControlStateNormal];
//        [_sureBtn setBackgroundImage:[SS_PublicTool getImageFromBundle:[SS_PublicTool getResourceBundle] withName:@"an_z2" withType:@"png"] forState:UIControlStateHighlighted];
...
- (UILabel *)tipsLab{
    if (!_tipsLab) {
        ...
        //
        NSString *text = [NSString stringWithFormat:@"您的账号为:%@", [SS_SDKBasicInfo sharedSS_SDKBasicInfo].fastUserName];

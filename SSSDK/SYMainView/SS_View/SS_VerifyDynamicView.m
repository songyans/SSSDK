...
@interface SS_VerifyDynamicView ()<UITextFieldDelegate>
...
@implementation SS_VerifyDynamicView
...
- (void)verifyClick{
    ...
    [[SS_SDKNetworkTool sharedSS_SDKNetworkTool] verifyDynamicPasswordWithKey:self.verifyTextField.text completion:^(BOOL isSuccess, id respones) {
        if (isSuccess) {
...
- (UIImageView *)bgImage{
    if (!_bgImage) {
        ...
        [_bgImage setImage:[SS_PublicTool getImageFromBundle:[SS_PublicTool getResourceBundle] withName:@"k_bg" withType:@"png"]];

...
@interface SS_ServiceAgreementView()
...
@implementation SS_ServiceAgreementView
...
- (UIButton *)agreeBtn{
    if (!_agreeBtn) {
        _agreeBtn = [SS_PublicTool createBtnWithButton:_agreeBtn buttonType:UIButtonTypeCustom frame:CGRectZero backgroundColor:nil image:nil normalTitle:nil selectedTitle:nil highlightTitle:nil textAlignment:nil selected:NO titleNormalColor:nil titleSelectedColor:nil titleHighlightedColor:nil];
        [_agreeBtn setImage:get_BundleImage(@"select_yes") forState:UIControlStateNormal];

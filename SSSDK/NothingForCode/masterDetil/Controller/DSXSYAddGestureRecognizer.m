...
#import "DSXSYAddGestureRecognizer.h"

@implementation DSXSYAddGestureRecognizer
...
+ (UILabel *)createPlaceholderWithText:(NSString *)placeholderText TextColor:(UIColor *)textColor FontSize:(NSInteger)size TextAlignment:(NSTextAlignment)textAlignment{
    UILabel *placeHolderLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 8,234324 - 37, 50)];
